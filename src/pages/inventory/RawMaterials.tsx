...
const RawMaterials = () => {
  ...
  const materials = [
    { id: "PRD000364", name: "All mectin استيكر الامكتين", type: "Material", category: "PM | Packaging Materials | خامات تغليف", subcategory: "استيكرات", customer: "ابو عدي", unitPrice: "0.00", costPrice: "-" },
    { id: "PRD000366", name: "All mectin علبه الامكتين", type: "Material", category: "PM | Packaging Materials | خامات تغليف", subcategory: "علب", customer: "ابو عدي", unitPrice: "0.00", costPrice: "-" },
    { id: "PRD000365", name: "All mectin نشره الامكتين", type: "Material", category: "PM | Packaging Materials | خامات تغليف", subcategory: "نشرات", customer: "ابو عدي", unitPrice: "0.00", costPrice: "-" },
    { id: "PRD000713", name: "ovi plex استيكر اوفي بلكس", type: "Material", category: "PM | Packaging Materials | خامات تغليف", subcategory: "استيكرات", customer: "د.احمد ممدوح", unitPrice: "0.00", costPrice: "-" },
    { id: "PRD000714", name: "ovi plex علبه اوفي بلكس", type: "Material", category: "PM | Packaging Materials | خامات تغليف", subcategory: "علب", customer: "د.احمد ممدوح", unitPrice: "0.00", costPrice: "-" },
  ];
  ...
  const filteredMaterials = materials.filter((material) => {
    ...
    const matchesCustomer = customerFilter === "all" || material.customer === customerFilter;
    return matchesSearch && matchesCustomer;
  });

  const handleView = (id: string) => {
    toast({ title: isRTL ? "عرض المادة" : "View Material", description: id });
  };

  const handleEdit = (id: string) => {
    toast({ title: isRTL ? "تعديل المادة" : "Edit Material", description: id });
  };

  const handleDelete = (id: string) => {
    toast({ title: isRTL ? "حذف المادة" : "Delete Material", description: id, variant: "destructive" });
  };
    ...
    <div className="min-h-screen bg-background" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <main className="max-w-[1600px] mx-auto px-4 py-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <h1 className="text-2xl font-bold">{isRTL ? "المواد الخام" : "Raw Materials"}</h1>
          ...
          <CardContent className="pt-6">
                ...
                <TableBody>
                  {filteredMaterials.map((material) => (
                    <TableRow key={material.id}>
                      ...
                      <TableCell>{material.customer}</TableCell>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-4">
              <p className="text-sm text-muted-foreground">
                {isRTL
                  ? `عرض 1 إلى ${filteredMaterials.length} من ${filteredMaterials.length} سجلات`
